...
<tr>
	...
	<table border=0 cellpadding=0 cellspacing=0 width=100%>
	<tr height=37>
		<td bgcolor="#F2F2F2" style="padding:10px;font-size:11px"><span style="color: #FF3243; font-weight: bold;">'<?=$search?>'</span><strong>전체[<?=$thiscodecnt?>]</strong> &nbsp;검색결과 내 전체 카테고리 : <?=$thiscatcount?>개
		<?if(strlen($str_navi)>0) echo $str_navi;?>
		</td>
	</tr>
	<tr height=37>
