...
<table align="center" border=0 cellpadding=0 cellspacing=0 width="<?=$size?>">
	<tr><td align=center width=<?=$size?> height=<?=$size?> style="border:0px solid #e8e8e8;"><a href="javascript:primage_view('<?=$productcode?>')"><img src="<?=$Dir?>images/common/trans.gif" border=0 alt="클릭하시면 큰 다중이미지를 보실수 있습니다." name=primg width=<?=$size?> height=<?=$size?>></a></td></tr>
