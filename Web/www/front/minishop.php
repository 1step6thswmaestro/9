...
<?
	if($_minidata->hot_used=="1") {
		...
		if(strlen($hot_disptype)>0 && $hot_dispcnt>0) {
			...
			$sql.= "a.option_price, a.tag, a.minimage, a.tinyimage, a.etctype, a.option_price, a.selfcode, a.prmsg FROM tblproduct AS a ";
...
?>
	...
	<col width=></col>
	<tr>
		<td style="padding:4px"><a href="javascript:ChangeSort('ord_qty');"><img src="<?=$Dir?>images/minishop/btn_sort_popular.gif" border=0 alt="인기상품순" align="absmiddle"></a><a href="javascript:ChangeSort('lprice');"><img src="<?=$Dir?>images/minishop/btn_sort_low.gif" border=0 alt="낮은가격순" align="absmiddle"></a><a href="javascript:ChangeSort('hprice');"><img src="<?=$Dir?>images/minishop/btn_sort_high.gif" border=0 alt="높은가격순" align="absmiddle"></a><a href="javascript:ChangeSort('cdate');"><img src="<?=$Dir?>images/minishop/btn_sort_new.gif" border=0 alt="신상품" align="absmiddle"></a></td>
		<td align="right" style="padding-right:5px">
			...
			<option value="12"<?if($listnum==12)echo" selected";?>>12개씩</option>
			<option value="24"<?if($listnum==24)echo" selected";?>>24개씩</option>
			<option value="36"<?if($listnum==36)echo" selected";?>>36개씩</option>
			<option value="48"<?if($listnum==48)echo" selected";?>>48개씩</option>
			<option value="60"<?if($listnum==60)echo" selected";?>>60개씩</option>
			</select>
		</td>
	</tr>
	<table>
