	...
	if(strlen($sp_prcode)>0) {
		...
		if($newitem_type=="1") {	####################################### 이미지A형 #########################
			...
			while($row=mysql_fetch_object($result)) {
				...
				$newitem1.="<tr>\n";
				$newitem1.="	<TD class=\"prImage\" align=\"center\">";
				...
				/*$newitem1.="
					<td valign=\"top\" style=\"height:76px; padding:15px 7px 4px 7px; border-bottom:1px solid #f2f2f2; word-break:break-all;\">
						<div style=\"height:36px;\"><A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode.$add_query."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><FONT class=\"mainprname\">".titleCut(50,viewproductname($row->productname,'',$row->selfcode))."</FONT>".(strlen($row->prmsg)?'<br /><span class="prmsgArea"></span>':'')."</A></div>";*/
                 $newitem1.="
					<td valign=\"top\" style=\"word-break:break-all;\">
						<div><A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode.$add_query."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><FONT class=\"mainprname\">".titleCut(50,viewproductname($row->productname,'',$row->selfcode))."</FONT>".(strlen($row->prmsg)?'':'')."</A></div>";
				$newitem1.="	</td>\n";
				$newitem1.="</tr>\n";
				...
				$newitem1.="</td>
								".(($row->discountRate>0) ? "<td><span class=\"discount\">".$discountRate."</span></td>" : "")."
						</tr>
					</table>
				";
				...
				//아이콘 출력
				$newitem1.="<tr>\n";
				$newitem1.="	<td>".viewproductname('',$row->etctype,$row->selfcode)."</td>\n";
				$newitem1.="</tr>\n";
			...
			while($row=mysql_fetch_object($result)) {
				...
				$newitem2.="<tr>\n";
				$newitem2.="	<td class=\"prImage\" align=\"center\" nowrap>";
				if (strlen($row->tinyimage)>0 && file_exists($Dir.DataDir."shopimages/product/".$row->tinyimage)==true) {
	...
	if(strlen($sp_prcode)>0) {
		...
		if($bestitem_type=="1") {	####################################### 이미지A형 ########################
			...
			while($row=mysql_fetch_object($result)) {
				...
				$bestitem1.="<tr>\n";
				$bestitem1.="	<TD class=\"prImage\" align=\"center\">";
				if (strlen($row->tinyimage)>0 && file_exists($Dir.DataDir."shopimages/product/".$row->tinyimage)==true) {
				...
				$bestitem1.="<tr>\n";
				$bestitem1.="	<td valign=\"top\" style=\"word-break:break-all;\"><A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode.$add_query."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><FONT class=\"mainprname\">".viewproductname($row->productname,$row->etctype,$row->selfcode)."</FONT>".(strlen($row->prmsg)?'<br><span class="prmsgArea">'.$row->prmsg.'</span>':'')."</A></td>\n";
				$bestitem1.="</tr>\n";
			...
			while($row=mysql_fetch_object($result)) {
				...
				$bestitem2.="<tr>\n";
				$bestitem2.="	<td class=\"prImage\" align=\"center\" nowrap>";
				if (strlen($row->tinyimage)>0 && file_exists($Dir.DataDir."shopimages/product/".$row->tinyimage)==true) {
	...
	if(strlen($sp_prcode)>0) {
		...
		if($hotitem_type=="1") {	####################################### 이미지A형 #########################
			...
			while($row=mysql_fetch_object($result)) {
				...
				$hotitem1.="<table border=0 cellpadding=0 cellspacing=0 width=\"".$tableSize."\" id=\"H".$row->productcode."\" onmouseover=\"quickfun_show(this,'H".$row->productcode."','')\" onmouseout=\"quickfun_show(this,'H".$row->productcode."','none')\" class=\"prInfoBox\">\n";
				$hotitem1.="<tr>\n";
				$hotitem1.="	<td class=\"prImage\" align=\"center\">";
				if (strlen($row->tinyimage)>0 && file_exists($Dir.DataDir."shopimages/product/".$row->tinyimage)==true) {
				...
				$hotitem1.="<tr>\n";
				$hotitem1.="	<td valign=\"top\" style=\"word-break:break-all;\"><A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode.$add_query."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><FONT class=\"mainprname\">".viewproductname($row->productname,$row->etctype,$row->selfcode)."</FONT>".(strlen($row->prmsg)?'<br><span class="prmsgArea">'.$row->prmsg.'</span>':'')."</A></td>\n";
				$hotitem1.="</tr>\n";
				...
				if($hotitem1_price=="Y" && $row->consumerprice>0) {	//소비자가
					$hotitem1.="	<span class=\"mainconprice\"><strike>".number_format($row->consumerprice)."원</strike></span>\n";
				}
				...
				$hotitem1.="	<span style=\"white-space:nowrap;\">".$strikeStart.$wholeSaleIcon.dickerview($row->etctype,"<strong class=\"".$mainprpriceClass."\">".number_format($row->sellprice)."원</strong>".$strikeEnd)."</span>";
				$hotitem1.="</td>";

				if($row->discountRate > 0){
					$hotitem1.="<td align=\"right\" valign=\"bottom\" class=\"discount\">".$discountRate."</td>";
				}
				$hotitem1.="
						</tr>
					</table>
				...
				//회원할인가 적용
				if( $memberprice > 0 ) {
					$hotitem1.="	<div><span class=\"mainprprice\">".dickerview($row->etctype,$memberprice)."원</span> <img src=\"".$Dir."images/common/memsale_icon.gif\" align=\"absmiddle\" alt=\"\" /></div>\n";
				}
				...
				if($hotitem1_reserve=="Y" && $reserveconv>0) {	//적립금
					$hotitem1.="	<div style=\"margin-top:5px;\"><img src=\"".$Dir."images/common/reserve_icon.gif\" border=\"0\" style=\"vertical-ailgn:middle;\" /> <span class=\"mainreserve\">".number_format($reserveconv)."</span>원</div>\n";
				}
			...
			while($row=mysql_fetch_object($result)) {
				...
				$hotitem2.="<table border=0 cellpadding=0 cellspacing=0 width=100% id=\"H".$row->productcode."\" style=\"table-layout:fixed\" onmouseover=\"quickfun_show(this,'H".$row->productcode."','','row')\" onmouseout=\"quickfun_show(this,'H".$row->productcode."','none')\" class=\"prInfoBox2\">\n";
				$hotitem2.="<col width=\"".$tableSize."\"></col><col width=0></col><col width=100%></col>\n";
				$hotitem2.="<tr>\n";
				$hotitem2.="	<td class=\"prImage\" align=\"center\" nowrap>";
				if (strlen($row->tinyimage)>0 && file_exists($Dir.DataDir."shopimages/product/".$row->tinyimage)==true) {
				...
				$hotitem2.="<td valign=middle style=\"padding-left:15\">\n";
				$hotitem2.="<table border=0 cellpadding=0 cellspacing=0 width=100% style=\"table-layout:fixed\">\n";
				$hotitem2.="<tr>\n";
				...
				if($hotitem2_price=="Y" && $row->consumerprice>0) {	//소비자가
					$hotitem2.="	<span class=\"mainconprice\"><strike>".number_format($row->consumerprice)."원</strike></span>\n";
				}
				...
				$hotitem2.=$strikeStart.$wholeSaleIcon.dickerview($row->etctype,"<strong class=\"".$mainprpriceClass."\">".number_format($row->sellprice)."원</strong>".$strikeEnd);
				...
				//회원할인가 적용
				if( $memberprice > 0 ) {
					$hotitem2.="	<div style=\"margin-top:4px;\"><span class=\"mainprprice\">".dickerview($row->etctype,$memberprice."원")."</span> <img src=\"".$Dir."images/common/memsale_icon.gif\" align=\"absmiddle\" alt=\"\" /></div>\n";
				}

				$reserveconv=getReserveConversion($row->reserve,$row->reservetype,$memberpriceValue,"Y");
				if($hotitem2_reserve=="Y" && $reserveconv>0) {	//적립금
					$hotitem2.="	<div style=\"margin-top:5px;\"><img src=\"".$Dir."images/common/reserve_icon.gif\" border=\"0\" style=\"vertical-ailgn:middle;\" /> <span class=\"mainreserve\">".number_format($reserveconv)."</span>원</div>";
				}
				...
				if( $row->vender > 0 ) {
					...
					// 네임텍 출력
					$hotitem2.= "	<div class=\"nameTagBox2\"><span class=\"name\">".$v_info['com_name']."</span> <span class=\"owner\">(".$v_info['com_owner'].")</span></div>";
					$hotitem2.= "	<div><a href=\"javascript:GoMinishop('/minishop.php?storeid=".$v_info['id']."')\"><img src=\"/images/common/icon_vender_go.gif\" border=\"0\" align=\"absmiddle\" alt=\"전체상품보기\" /></a></div>";
				}
			...
			while($row=mysql_fetch_object($result)) {
				...
				$hotitem3.= "	<td style=\"padding-left:5\"><A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode.$add_query."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><FONT class=\"mainprname\">".viewproductname($row->productname,$row->etctype,$row->selfcode)."</FONT>".(strlen($row->prmsg)?'<br><span class="prmsgArea">'.$row->prmsg.'</span>':'')."</A>";
				...
				$hotitem3.= "		<td align=left class=\"mainprprice\">".$strikeStart.$wholeSaleIcon.dickerview($row->etctype,number_format($row->sellprice)."원".$strikeEnd).$discountRate;
				$hotitem3.= "		</td>\n";
				$hotitem3.= "	</tr>\n";
				...
				if( $memberprice > 0 ) {
					$hotitem3.="<tr>\n";
					$hotitem3.="	<td align=center valign=top style=\"word-break:break-all;\" class=\"mainprprice\"><img src=\"".$Dir."images/common/memsale_icon.gif\" style=\"position:relative; top:0.1em;\" alt=\"\" />".dickerview($row->etctype,$memberprice."원");
					$hotitem3.="	</td>\n";
					$hotitem3.="</tr>\n";
				}
				...
				if($hotitem3_reserve=="Y") {
					$reserveconv=getReserveConversion($row->reserve,$row->reservetype,$memberpriceValue,"Y");
					$hotitem3.= "	<tr><td align=left class=mainreserve><img src=\"".$Dir."images/common/reserve_icon.gif\" border=0 style=\"position:relative; top:0.1em;\"> ".number_format($reserveconv)."원</td></tr>\n";
				}
				$hotitem3.= "	</table>\n";
				$hotitem3.= "	</td>\n";
				$hotitem3.= "</tr>\n";
	...
	if(strlen($sp_prcode)>0) {
		...
		if($speitem_type=="0") {		####################################### 기존방식 ######################
			...
			while($row=mysql_fetch_object($result)) {
				...
				$speitem0.="		<tr>\n";
				$speitem0.="			<td style=\"word-break:break-all;\"><A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><FONT class=\"mainspname\">".viewproductname($row->productname,$row->etctype,$row->selfcode)."</FONT>".(strlen($row->prmsg)?'<br><span class="prmsgArea">'.$row->prmsg.'</span>':'')."</A></td>\n";
				$speitem0.="		</tr>\n";
				//모델명/브랜드/제조사/원산지
			...
			while($row=mysql_fetch_object($result)) {
				...
				$speitem1.="<tr>\n";
				$speitem1.="	<td class=\"prImage\" align=\"center\">";
				if (strlen($row->tinyimage)>0 && file_exists($Dir.DataDir."shopimages/product/".$row->tinyimage)==true) {
				...
				$speitem1.="<tr>\n";
				$speitem1.="	<td valign=\"top\" style=\"word-break:break-all;\"><A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode.$add_query."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><FONT class=\"mainprname\">".viewproductname($row->productname,$row->etctype,$row->selfcode)."</FONT>".(strlen($row->prmsg)?'<br><span class="prmsgArea">'.$row->prmsg.'</span>':'')."</A></td>\n";
				$speitem1.="</tr>\n";
			...
			while($row=mysql_fetch_object($result)) {
				...
				$speitem2.="<tr>\n";
				$speitem2.="	<td class=\"prImage\" align=\"center\" nowrap>";
				if (strlen($row->tinyimage)>0 && file_exists($Dir.DataDir."shopimages/product/".$row->tinyimage)==true) {
			...
			if($codeitem_type=="1") {
				...
				while($row=mysql_fetch_object($result)) {
					...
					if($codeitem_reserve=="Y" && $reserveconv>0) {	//적립금
						$codeitem_replace[$zz].="<tr>\n";
						$codeitem_replace[$zz].="	<td align=center valign=top style=\"word-break:break-all;\" class=\"mainreserve\"><img src=\"".$Dir."images/common/reserve_icon.gif\" border=0 style=\"position:relative; top:0.1em;\"> ".number_format($reserveconv)."원";
						$codeitem_replace[$zz].="	</td>\n";
						$codeitem_replace[$zz].="</tr>\n";
					}
					//태그관련
...
for ( $catebestitem_i = 1; $catebestitem_i < 9; $catebestitem_i++ ){
	...
	if ($pointNum = strpos($main_body,$macroKey)) {
		...
		if(strlen($sp_prcode)>0) {
			...
			$catebestitem.="<table border=0 cellpadding=0 cellspacing=0 width=100% style=\"table-layout:fixed\">\n";
			$catebestitem.="<tr>\n";
			$catebestitem.="	<td>\n";
			$catebestitem.="	<table border=0 cellpadding=0 cellspacing=0 width=100%>\n";
			for($j=0;$j<$catebestitem_cols;$j++) {
				if($j>0) $catebestitem.= "<col width=10></col>\n";
				$catebestitem.= "<col width=".floor(100/$catebestitem_cols)."%></col>\n";
			}
			$catebestitem.="	<tr>\n";
			...
			while($row=mysql_fetch_object($result)) {
				...
				if ($i>0 && $i%$catebestitem_cols==0) {
					if($catebestitem_colline=="Y") {
						$catebestitem.="<tr><td colspan=".$catebestitem_colnum." ";
						if(eregi("#prlist_colline",$body)) {
							$catebestitem.= "id=prlist_colline></td></tr>\n";
						} else {
							$catebestitem.= "height=1><table border=0 cellpadding=0 cellspacing=0 height=1 style=\"table-layout:fixed\"><tr><td height=1 style=\"border:1 dotted #DDDDDD\"><img width=1 height=0></td></tr></table></td></tr>\n";
						}
						//$catebestitem.="<tr><td colspan=".$catebestitem_colnum." height=".$catebestitem_gan."></td></tr><tr>\n";
					} else {
						$catebestitem.="<tr>\n";
					}
				}
				if ($i!=0 && $i%$catebestitem_cols!=0) {
					$catebestitem.="<td width=10 height=100% align=center nowrap>";
					if($catebestitem_rowline=="N") $catebestitem.="<img width=3 height=0>";
					else if($catebestitem_rowline=="Y") {
						$catebestitem.="<table border=0 cellpadding=0 cellspacing=0 width=1 height=100 style=\"table-layout:fixed\"><tr><td ";
						if(eregi("#prlist_rowline",$body)) {
							$catebestitem.= "id=prlist_rowline height=100></td></tr></table>\n";
						} else {
							$catebestitem.= "width=1 height=100 style=\"border:1 dotted #DDDDDD\"><img width=1 height=0></td></tr></table>\n";
						}
					} else if($catebestitem_rowline=="L") {
						$catebestitem.="<table border=0 cellpadding=0 cellspacing=0 width=1 height=100% style=\"table-layout:fixed\"><tr><td ";
						if(eregi("#prlist_rowline",$body)) {
							$catebestitem.= "id=prlist_rowline height=100%></td></tr></table>\n";
						} else {
				...
				$catebestitem.="<td>\n";
				$catebestitem.="<table border=0 cellpadding=0 cellspacing=0 id=\"B".$row->productcode."\" onmouseover=\"quickfun_show(this,'B".$row->productcode."','')\" onmouseout=\"quickfun_show(this,'B".$row->productcode."','none')\">\n";
				$catebestitem.="<tr>\n";
				$catebestitem.="	<td align=center>";
				$catebestitem.="	<table border=0 cellpadding=0 cellspacing=0 width=100><tr><td height=90>";
				if (strlen($row->tinyimage)>0 && file_exists($Dir.DataDir."shopimages/product/".$row->tinyimage)==true) {
					$catebestitem.="<A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode.$add_query."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><img src=\"".$Dir.DataDir."shopimages/product/".urlencode($row->tinyimage)."\" border=0 height=80";
				} else {
					$catebestitem.="<img src=\"".$Dir."images/no_img.gif\" border=0 align=center";
				}
				$catebestitem.="></A></td>\n";
				$catebestitem.="</tr>\n";
				$catebestitem.="<tr><td height=\"3\" style=\"position:relative;\">".($_data->ETCTYPE["QUICKTOOLS"]!="Y"?"<script>quickfun_write('".$Dir."','B','".$row->productcode."','".($row->quantity=="0"?"":"1")."')</script>":"")."</td></tr></table></td>\n";

				//$catebestitem.="<tr>\n";

				$catebestitem.="<td><table border=0 cellpadding=0 cellspacing=0><tr>";

				$catebestitem.="	<td style=\"word-break:break-all;\"><A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode.$add_query."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><FONT class=\"mainprname\">".titleCut(28,viewproductname($row->productname,$row->etctype,$row->selfcode))."</FONT></A></td>\n";
				$catebestitem.="</tr>\n";

				/* 브랜드 출력 처리 20131029 J.Bum */
				if(strlen($row->brand)>0) {
					$catebestitem.="<tr><td class=\"mainproduction\">".$arBrand[$row->brand]."</td></tr>";
				}

				if($catebestitem_price=="Y" && $row->consumerprice>0) {	//소비자가
					$catebestitem.="<tr>\n";
					$catebestitem.="	<td style=\"word-break:break-all;\" class=\"mainconprice\"><s>".number_format($row->consumerprice)."원</s></td>\n";
					$catebestitem.="</tr>\n";
				}

				$catebestitem.="<tr>\n";
				$catebestitem.="	<td style=\"word-break:break-all;\">";
				if($dicker=dickerview($row->etctype,number_format($row->sellprice)."원",1)) {
					$catebestitem.= $dicker;
				} else if(strlen($_data->proption_price)==0) {
					if($row->consumerprice>0) {	//소비자가
						$catebestitem.= "<span class=\"mainconprice\"><s>".number_format($row->consumerprice)."원</s> &nbsp;&gt;</span>&nbsp;";
					}
						$catebestitem.= "<span class=\"mainprprice\"><b>".number_format($row->sellprice)."원</b></span>";
					if (strlen($row->option_price)!=0) $catebestitem.= "(기본가)";
				} else {
					$catebestitem.="<img src=\"".$Dir."images/common/won_icon.gif\" border=0 align=absmiddle> ";
					if (strlen($row->option_price)==0){
						$catebestitem.=  "<span class=\"prconsumerprice\"><s>".number_format($row->consumerprice)."원</s></span> ".number_format($row->sellprice)."원";
					}else{
						$catebestitem.= ereg_replace("\[PRICE\]",number_format($row->sellprice),$_data->proption_price);
					}
				}

				if ($row->quantity=="0") $catebestitem.= soldout();
				$catebestitem.="	</td>\n";
				$catebestitem.="</tr>\n";
				$reserveconv=getReserveConversion($row->reserve,$row->reservetype,$row->sellprice,"Y");
				if($catebestitem_reserve=="Y" && $reserveconv>0) {	//적립금
					$catebestitem.="<tr>\n";
					$catebestitem.="	<td style=\"word-break:break-all;\" class=\"prreserve\"><img src=\"".$Dir."images/common/reserve_icon.gif\" border=0 style=\"position:relative; top:0.1em;\"> ".number_format($reserveconv)."원";
					$catebestitem.="	</td>\n";
					$catebestitem.="</tr>\n";
				}

				$catebestitem.="</table></td></tr>";

				$catebestitem.="</table>\n";
				$catebestitem.="</td>\n";
				$i++;

				if ($i==$catebestitem_product_num) break;
				if ($i%$catebestitem_cols==0) {
					$catebestitem.="</tr><tr><td colspan=".$catebestitem_colnum." height=".$catebestitem_gan."></td></tr>\n";
				}
			}
			if($i>0 && $i<$catebestitem_cols) {
				for($k=0; $k<($catebestitem_cols-$i); $k++) {
					$catebestitem.="<td></td>\n<td></td>\n";
				}
			}
			if($i == 0){ //등록된 상품이 없을 때
				$catebestitem.="<tr><td height=40 colspan=10 align=center>등록된 상품이 없습니다.</td>";
			}
			mysql_free_result($result);
			...
			${"catebestitem".$catebestitem_i} = $catebestitem;
		}
	}
}
