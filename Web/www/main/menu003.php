...
?>
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td><IMG SRC="<?=$Dir?>images/<?=$_data->icon_type?>/<?=$boardlisttitleimg?>" border="0"></td>
			</tr>
			<tr>
				<td style="padding-left:15px;padding-right:15px;">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				//$boardname
					...
					if(_array($boardname)){
						foreach($boardname as $brname){
							...
							echo "	<td width=100% style=\"padding-left:5px;\"><A HREF=\"".$Dir.BoardDir."board.php?board=".$boardcodename[$boardloop]."\"><FONT class=leftcommunity>".$brname."</FONT></A></td>\n";
							echo "</tr>\n";
							$boardloop++;
						}
					}
