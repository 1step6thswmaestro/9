...
<TD width="100%" background="images/title_bg.gif" height="21"></TD>
			...
			<tr><td height="20"></td></tr>
			<tr>
				<td><IFRAME name="MainPrdtFrame" src="design_eachplist.list.php" width=100% height=350 frameborder=0 align=TOP scrolling="no" marginheight="0" marginwidth="0"></IFRAME></td>
			</tr>
			</form>
