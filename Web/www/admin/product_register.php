...
function fResize() {
	...
	ifrmHeight = objBody.scrollHeight+100;
...
<table cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				<td height="20"><DIV id="loadingIMG" align='center' style="display:none;"><img src="/images/loading.gif"><br /><B>로딩중.....</B></DIV></td>
			</tr>

			<tr>
				<td align="center"><IFRAME name="AddFrame" id="AddFrame" src="<?=$Dir?>blank.php" width=100% frameborder=0 align=TOP scrolling="no" marginheight="0" marginwidth="0" style="height:0px;"></IFRAME></td>
			</tr>
