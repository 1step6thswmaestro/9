...
<?
			...
			noselectmenu('쇼핑몰 이용약관','shop_agreement.php',$idx[0][4],1);
			noselectmenu('쇼핑몰 개인정보취급방침','shop_privercyinfo.php',$idx[0][5],2);
?>
			</table>
			</div>
			</td>
...
<?
			...
			noselectmenu('로고/배너 관리','shop_logobanner.php',$idx[1][6],1);
