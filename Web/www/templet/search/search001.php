		...
		<tr>
			...
			<tr>
				...
				<tr>
					...
					<td>
						<select name="codeA" style="width:175px" onchange="SearchChangeCate(this,1)" style="font-size:11px;">
							<option value="">--- 1차 카테고리 선택 ---</option>
						</select>
						<select name="codeB" style="width:175px" onchange="SearchChangeCate(this,2)" style="font-size:11px;">
				...
				<TR>
					<TD></td>
					<td>
						<select name="codeC" style="width:175px;" onchange="SearchChangeCate(this,3)" style="font-size:11px;">
							<option value="">--- 3차 카테고리 선택 ---</option>
						</select>
						<select name="codeD" style="width:175px" style="font-size:11px;">
				...
				<tr>
					...
					<td><input type=text name=minprice value="<?=$minprice?>" style="WIDTH: 162px" onkeyup="strnumkeyup(this)" class="input" style="BACKGROUND-COLOR:#F7F7F7;">원 ~ <input type=text name=maxprice value="<?=$maxprice?>" style="WIDTH: 163px" onkeyup="strnumkeyup(this)" class="input" style="BACKGROUND-COLOR:#F7F7F7;">원</td>
				</tr>
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin3_icon3.gif" border="0"></td>
					<td>
						<select name=s_check style="width:90px;" style="font-size:11px;">
				...
				<?=$subSrchIf1S?>
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin3_icon5.gif" border="0"></td>
					<td><? /*<select name=s_check1 style="width:90px;" style="font-size:11px;">
						<option value="all" <?if($s_check1=="all")echo"selected";?>>통합검색</option>
						<option value="keyword" <?if($s_check1=="keyword")echo"selected";?>>상품명/키워드</option>
						<option value="code" <?if($s_check1=="code")echo"selected";?>>상품코드</option>
						<option value="selfcode" <?if($s_check1=="selfcode")echo"selected";?>>진열코드</option>
						<option value="production" <?if($s_check1=="production")echo"selected";?>>제조사</option>
						<option value="model" <?if($s_check1=="model")echo"selected";?>>모델명</option>
						<option value="content" <?if($s_check1=="content")echo"selected";?>>상세설명</option>
						<option value="prmsg" <?if($s_check1=="prmsg")echo"selected";?>>홍보문구</option>
						</select> */ ?><input type=text name=search1 value="<?=$search1?>" style="WIDTH: 277px;BACKGROUND-COLOR:#F7F7F7;" class="input"></td>
				</tr>
				<?=$subSrchIf1E?>

				<?=$subSrchIf2S?>
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin3_icon6.gif" border="0"></td>
					<td><? /*<select name=s_check2 style="width:90px;" style="font-size:11px;">
						<option value="all" <?if($s_check2=="all")echo"selected";?>>통합검색</option>
						<option value="keyword" <?if($s_check2=="keyword")echo"selected";?>>상품명/키워드</option>
						<option value="code" <?if($s_check2=="code")echo"selected";?>>상품코드</option>
						<option value="selfcode" <?if($s_check2=="selfcode")echo"selected";?>>진열코드</option>
						<option value="production" <?if($s_check2=="production")echo"selected";?>>제조사</option>
						<option value="model" <?if($s_check2=="model")echo"selected";?>>모델명</option>
						<option value="content" <?if($s_check2=="content")echo"selected";?>>상세설명</option>
						<option value="prmsg" <?if($s_check2=="prmsg")echo"selected";?>>홍보문구</option>
						</select> */ ?><input type=text name=search2 value="<?=$search2?>" style="WIDTH: 277px;BACKGROUND-COLOR:#F7F7F7;" class="input"></td>
				</tr>
				<?=$subSrchIf2E?>
