				...
				<td width="100%" style="padding:30px;">
					<table cellpadding="0" cellspacing="0">
						<tr>
							...
							<td valign="bottom" style="font-size:28px;line-height:28px;letter-spacing:-0.5pt;"><font color="#FF6600"><b><?=$t_count?>개</b></font></td>
							<td><img src="<?=$Dir?>images/common/wishlist/<?=$_data->design_wishlist?>/wishlist_skin3_t_text2.gif" border="0"></td>
						</tr>
					</table>
				</td>
				<td background="<?=$Dir?>images/common/wishlist/<?=$_data->design_wishlist?>/design_search_skin3_t4bg.gif"></td>
			</tr>
		</table>
		</td>
	</tr>
...
<?
		...
		while($row=mysql_fetch_object($result)) {
			...
			echo "		<td align=\"right\" style=\"padding-right:5\"><A HREF=\"javascript:CheckForm('',".$row->wish_idx.")\"><img src=\"".$Dir."images/common/wishlist/".$_data->design_wishlist."/wishlist_skin3_btn03.gif\" border=\"0\"></A></td>\n";
			echo "	</tr>\n";
			echo "	<tr>\n";
			...
			echo "		</table>\n";
			echo "		</td>\n";
			echo "		<td align=\"right\" style=\"padding-right:5\"><A HREF=\"javascript:CheckForm('ordernow',".$row->wish_idx.")\"><img src=\"".$Dir."images/common/wishlist/".$_data->design_wishlist."/wishlist_skin3_btn04.gif\" border=\"0\"></A></td>\n";
			echo "	</tr>\n";
			echo "	<tr>\n";
			echo "		<td style=\"padding-left:5px;padding-right:5px;\">\n";
			echo "		<table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\n";
			...
			echo "		</table>\n";
			echo "		</td>\n";
			echo "		<td align=\"right\" style=\"padding-right:5\"><A HREF=\"javascript:SaveMemo(".$row->wish_idx.")\"><img src=\"".$Dir."images/common/wishlist/".$_data->design_wishlist."/wishlist_skin3_btn05.gif\" border=\"0\"></A></td>\n";
			echo "	</tr>\n";
			echo "	</table>\n";
			echo "	</td>\n";
			echo "</tr>\n";
...
?>
		<tr>
			<td height="3" background="<?=$Dir?>images/common/wishlist/<?=$_data->design_wishlist?>/wishlist_skin3_line.gif"></td>
		</tr>
		</table>
		</td>
	</tr>
