...
<tr>
	...
	<?
					// 구매대행 재고 원사이트 링크
					if(file_exists($Dir."service/cosmos/cosmos.class.php")){
						$Purl = mysql_fetch_assoc( mysql_query( "SELECT C.Purl  FROM `tblproduct` as P, `cosmos_product` as C WHERE P.`productcode` = '".$productcode."' AND P.pridx = C.Pcode LIMIt 1 ; " ) );
						$Purl = $Purl["Purl"];
					}
					...
					if($multi_img=="Y") {
						...
						echo "<tr><td align=\"center\" style=\"padding:10px;\">";
	...
	?>
					...
					<td valign="top">
						<table cellpadding="0" cellspacing="0" width="100%" border="0">
							...
							<tr><td bgcolor="#E8E8E8" HEIGHT="1"></td></tr>
							<tr><td height="12"></td></tr>
							<tr>
								<td>
									<table cellpadding="0" cellspacing="0" width="100%" border="0">
...
<? if($odrChk &&($_pdata->present_state == "Y" || $_pdata->pester_state == "Y")){ ?>
					...
					<tr>
						<td align="right" style="font-size:0px;">
							<?if($_pdata->pester_state == "Y"){?><a href="javascript:CheckForm('pester','<?=$opti?>')"><img src="<?=$Dir?>images/design/productdetail_pester.gif" border="0" /></a><?}?>
							<?if($_pdata->present_state == "Y"){?><a href="javascript:CheckForm('present','<?=$opti?>')"><img src="<?=$Dir?>images/design/productdetail_present.gif" hspace="4" border="0" /></a><?}?>
						</td>
					</tr>
<? } ?>
			...
			<tr>
				<td style="border:1px solid #dddddd; border-left:hidden; border-right:hidden; padding:15px; 0px;">
					...
					<table cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<tr>
							<td height="30" valign="top" style="font-size:11px; color:#666666;">* 이 상품은 <b>중복쿠폰이 적용되지 않는</b> 상품입니다. / 이 상품에 적용 가능한 쿠폰이 없습니다.</td>
						</tr>
						<tr>
							<td>
								<table cellpadding="0" cellspacing="0" border="0" width="100%">
									<tr>
										<td>
											...
											<!--쿠폰출력-->
											<div style="border:3px solid #ddd; width:150px; min-height:55px; _height:55px;">
												<ul style="list-style:none; margin:0px; padding:0px;">
													<li style="width:100%; color:#bbb; font-family:verdana; font-size:10px; font-weight:bold; padding-left:5px;">COUPON</li>
													<li style="float:right; width:100%; color:#ff3300; text-align:center; line-height:30px; font-weight:bold;"><span style="font-family:verdana; font-size:20px; letter-spacing:-0.1em;">10</span>% 할인</li>
												</ul>
											</div>
											<div style="width:150px; height:25px; line-height:25px; text-align:center;"><a href="#" onmouseover="showInfo.style.visibility='visible'" onmouseout="showInfo.style.visibility='hidden'">쿠폰정보</a> | <a href="#"><span style="font-weight:bold;">다운로드</span></a></div>
											<div id="showInfo" style="width:200px; margin:0px; padding:10px; position:absolute; background:#ffffff; color:#666; font-size:11px; border:1 solid #ccc; visible; z-index:100; visibility:hidden;">
												<span style="color:#444; font-size:12px; font-weight:bold;">쿠폰명 : 10% 할인쿠폰</span><br />
												사용기간 : 2013/10/10~2013/10/30<br />
												적용대상 : 전체 상품
											</div>
										...
										<td>
											<div style="border:3px solid #ddd; width:150px; min-height:55px; _height:55px;">
												<ul style="list-style:none; margin:opx; padding:0px;">
													<li style="width:100%; color:#bbb; font-family:verdana; font-size:10px; font-weight:bold; padding-left:5px;">COUPON</li>
													<li style="float:right; width:100%; color:#ff3300; text-align:center; line-height:30px; font-weight:bold;"><span style="font-family:verdana; font-size:20px; letter-spacing:-0.1em;">1,000</span>원 할인</li>
												</ul>
											</div>
											<div style="width:150px; height:25px; line-height:25px; text-align:center;"><a href="#" onmouseover="showInfo2.style.visibility='visible'" onmouseout="showInfo2.style.visibility='hidden'">쿠폰정보</a> | <a href="#"><span style="font-weight:bold;">다운로드</span></a></div>
											<div id="showInfo2" style="width:200px; margin:0px; padding:10px; position:absolute; background:#ffffff; color:#666; font-size:11px; border:1 solid #ccc; visible; z-index:100; visibility:hidden;">
												<span style="color:#444; font-size:12px; font-weight:bold;">쿠폰명 : 1,000원 할인쿠폰</span><br />
												사용기간 : 2013/10/10~2013/10/30<br />
												적용대상 : 전체 상품
											</div>
										</td>
										<td>
											<div style="border:3px solid #ddd; width:150px; min-height:55px; _height:55px;">
												<ul style="list-style:none; margin:opx; padding:0px;">
													<li style="width:100%; color:#bbb; font-family:verdana; font-size:10px; font-weight:bold; padding-left:5px;">COUPON</li>
													<li style="float:right; width:100%; color:#ff3300; text-align:center; line-height:30px; font-weight:bold;"><span style="font-family:verdana; font-size:20px; letter-spacing:-0.1em;">3</span>% 적립</li>
												</ul>
											</div>
											<div style="width:150px; height:25px; line-height:25px; text-align:center;"><a href="#">쿠폰정보</a> | <a href="#"><span style="font-weight:bold;">다운로드</span></a></div>
										</td>
										<td>
											<div style="border:3px solid #ddd; width:150px; min-height:55px; _height:55px;">
												<ul style="list-style:none; margin:opx; padding:0px;">
													<li style="width:100%; color:#bbb; font-family:verdana; font-size:10px; font-weight:bold; padding-left:5px;">COUPON</li>
													<li style="float:right; width:100%; color:#ff3300; text-align:center; line-height:30px; font-weight:bold;"><span style="font-family:verdana; font-size:20px; letter-spacing:-0.1em;">10,000</span>원 적립</li>
												</ul>
											</div>
											<div style="width:150px; height:25px; line-height:25px; text-align:center;"><a href="#">쿠폰정보</a> | <a href="#"><span style="font-weight:bold;">다운로드</span></a></div>
										</td>
								...
								<table cellpadding="0" cellspacing="0" width="100%">
									<tr>
										...
										<?
											...
											// 구매대행 내용에 멀티 이미지 추가
											if(file_exists($Dir."service/cosmos/cosmos.class.php")){
												$widthlimit = 700; // 이미지 폭 제한
												$sql = "select * from cosmos_image where pridx='".$_pdata->pridx."' order by `type` desc, idx asc";
												if(false !== $res = mysql_query($sql,get_db_conn())){
													if(mysql_num_rows($res)){
														$mimgitems = array();
														$cstrformat = '<table border="0" cellpadding="0" cellspacing="0" style="border:1px solid #efefef; margin-bottom:10px;"><caption style="background:#CCC; text-align:center; padding:3px; font-weight:bold;">%1$s</caption><tr><td><img src="%2$s" border="0" alt="%1$s" /></td></tr></table>';
														$coloridx = 0;
														$colorArrs = array();
														if(strlen(trim($_pdata->option1)) > 0) $colorArrs = explode(',',$_pdata->option1);

														while($mimg = mysql_fetch_assoc($res)){
															// 스틸 이미지 등 크기가 클경우 크기 조정
															$zoomimg = '/data/shopimages/multi/'.$mimg['zoom'];
															if(!is_file('../'.$zoomimg) || filesize('../'.$zoomimg) < 10) continue;
															$imginfotmp = @getimagesize('../'.$zoomimg);
															$imgtag = '<img src="/data/shopimages/multi/'.$mimg['zoom'].'" border="0" '.(($imginfotmp[0] > $widthlimit)?' width="'.$widthlimit.'px"':'').' style="margin-top:25px;" />';


															if($mimg['type'] == 'Color' && count($colorArrs)){
																$opidx = intval(substr($mimg['zoom'],0,2))+1;

																if(isset($colorArrs[$opidx])){
																	$imgtag .= '<br>'.$colorArrs[$opidx];
																	array_push($mimgitems,$imgtag);
																	continue;
																}
															}
															array_push($mimgitems,$imgtag);
														}
														if(count($mimgitems)) $_pdata->content .= '<div style="text-align:center">'.implode('<br />',$mimgitems).'</div>';
													}
												}
											}
