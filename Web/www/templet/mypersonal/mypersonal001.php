					...
					<td>
						<table cellpadding="0" cellspacing="0" width="100%">
							<tr>
								...
								<td style="padding-bottom:3px;"><A HREF="javascript:PersonalWrite()"><IMG SRC="<?=$Dir?>images/common/mypersonal/<?=$_data->design_mypersonal?>/mypersonal_skin3_btn1.gif" BORDER="0"></A></td>
							</tr>
						</table>
					</td>
				</tr>
