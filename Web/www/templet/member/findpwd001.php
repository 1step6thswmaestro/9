	...
	<tr>
		...
		<tr>
			...
			<tr>
				...
				<td><A HREF="javascript:CheckForm()"><img src="<?=$Dir?>images/member/idsearch_skin3_pwbtn.gif" border="0"></a><A HREF="<?=$Dir.FrontDir?>login.php"><img src="<?=$Dir?>images/member/idsearch_skin3_loginbtn.gif" border="0"></a></td>
			</tr>
			</table>
			</td>
		</tr>
