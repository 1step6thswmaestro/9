		...
		<tr bgcolor="#FFFFFF" onmouseover="this.style.background='#ffffff';" onmouseout="this.style.background='#FFFFFF';">
			<td style="padding-top:10; padding-bottom:10;" class="mypage_order_line" valign="top">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr><td height=5></td></tr>
					<tr><td class="mypage_list_cont"><A HREF="javascript:OrderDetailPop('<?=$row->ordercode?>')" onmouseover="window.status='주문내역조회';return true;" onmouseout="window.status='';return true;"><img src="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_order_icon01.gif" alt="보기" /></a>
					<?
					/*
...
<?				$chkbox_count = 0;
	...
	?>
		...
		-->
						...
						<td align=center><? if($row2->deli_gbn=="Y" && $_data->review_type !="N") { ?><!-- <A HREF="javascript:OrderReview('<?=$row->ordercode?>','<?=$row2->productcode?>')" onmouseover="window.status='상품평';return true;" onmouseout="window.status='';return true;"> --><A HREF="javascript:OrderReview('<?=$row2->productcode?>')"><img src="<?=$Dir?>images/common/mypage_detailview.gif" border="0" alt="상품평작성" /></A><? }else{ ?><img src="<?=$Dir?>images/common/mypage_detailview_off.gif" alt="상품평작성" /><? } ?>
						</td>
					</tr>
				<? } // end for by jj ?>
