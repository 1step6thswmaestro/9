...
if(strlen($email)<=0) {
	...
	if ($row=mysql_fetch_object($result)) {
		...
		if($row2=mysql_fetch_object($result2)) {
			...
			$message="<font color=#0000ff><b>사용가능한 이메일 입니다.</b><br><a class=\"button black small\" href=\"javascript:useEmail();\">사용하기</a></font>";
		}
...
<TR>
	<TD style="width:100%;height:40px;background-color:#888;text-align:center;font-weight:bold;font-size:1.2em;color:#FFF">이메일 중복확인</TD>
</TR>
<TR>
	<TD>
