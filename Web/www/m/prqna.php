...
?>
	<div class="qna">
		<span><strong><?=$boardrowcount?>건</strong>의 상품문의가 있습니다.</span>
		<?
		if($set_qna_list_write == "Y" || $set_qna_list_write == "A"){
			if($_ShopInfo->getMemid() != "" || $_ShopInfo->getMemid() != null){
		?>
			<div style="float:right; margin-right:10px;"><a class="button blue small" href="./customer_qna_write.php?board=qna&pridx=<?=$pridx?>" rel="external">문의하기</a></div>
		<?
			}
