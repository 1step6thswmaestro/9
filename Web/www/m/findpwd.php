...
<div id="content">
	...
	<div>
		<form name="form1" action="<?=$_SERVER[PHP_SELF]?>" method="post">
			...
			<?}?>
			<div style="margin:0px 0px 10px 12px; padding-top:60px; background:url('skin/default/img/idpw_bg.png') no-repeat 0px 10px; background-size:auto 39px;">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="memJoinForm">
				...
				<col width=""></col>
				<tr>
					<th><font color="#F02800"><b>＊</b></font>이름</th>
					<td><input type="text" name="name" value="" maxlength="20" style="WIDTH:90%;" /></td>
				</tr>
				<tr>
					<th><font color="#F02800"><b>＊</b></font>이메일주소</th>
					<td><input type="text" name="email" value="" maxlength="50" style="width:90%;" /></td>
				</tr>
			</table>
		</form>
		<div style="text-align:center; margin:15px 0px 50px 0px;">
			<A HREF="javascript:CheckForm();" class="button blue bigrounded">비밀번호 확인</a>
			<A HREF="./login.php" class="button white bigrounded">로그인</a>
		</div>
	</div>
<div>
