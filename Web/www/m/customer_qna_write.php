...
<div id="content">
	...
	<div style="text-align:center; margin:10px 0px 30px 0px;"><a class="button black bigrounded" id="btn_submit">문의등록</a> <a class="button white bigrounded" id="btn_reset">다시작성</a></div>
	</form>
</div>
