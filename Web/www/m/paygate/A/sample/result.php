...
<body>
    <form name="cancel" action="./cancel.php?param=<?=$tno?>" method="post">
    <div id="sample_wrap">
...
<?
    // 처리 페이지(pp_ax_hub.php)에서 가맹점 DB처리 작업이 실패한 경우 상세메시지를 출력합니다.
    if( !$res_msg_bsucc == "")
    {
?>
                         <tr>
...
?>
                    <tr>
                        <th>영수증 확인</th>
                        <td class="sub_content1"><a href="javascript:receiptView('<?=$tno?>')"><img src="./img/btn_receipt.png" alt="영수증을 확인합니다." />
                    </td>
                    </table>
<?
                }
