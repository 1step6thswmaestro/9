<div class="wishlist_container">
	<div id="content">
		...
		<div class="wishlist_wrap">
			...
			<h2>Wishlist에 <span class="point3"><?=$t_count?>개</span>의 상품이 등록되어 있습니다.</h2>
			<?
			...
			?>
					...
					<div class="wishlist_list">
						...
						<div class="wishlist_btn_wrap">
							<a href="#" class="button black small" onClick="javascript:CheckForm('ordernow','<?=$row->wish_idx?>')"><span>바로구매</span></a>
							<a href="#" class="button white small" onClick="javascript:CheckForm('','<?=$row->wish_idx?>')"><span>장바구니</span></a>
						</div>
					</div>
				</li>
				<?
			...
			<section class="basic_btn_area btn_w1 btn_fs1">
				<a href="#" class="button white" onClick="CheckBoxAll()">전체상품선택</a>&nbsp;
				<a href="#" class="button white" onClick="GoDelete()">선택상품삭제</a>
			</section>
		</div>
	</div>
</div>