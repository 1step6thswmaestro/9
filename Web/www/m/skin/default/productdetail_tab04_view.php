<!-- view탭 -->
		...
		<section class="tab_area"> 
			<ul class="tab_type1 tab01">
				...
				<!-- <li><a href="productdetail_tab02.php?productcode=<?=$productcode?>&sort=<?=$sort?>#tapTop" rel="external">상세정보</a></li> -->
				<li><a href="productdetail_tab03.php?productcode=<?=$productcode?>&sort=<?=$sort?>#tapTop" rel="external">상품평(<?=$t_cnt3?>)</a></li>
				<li class="active"><a href="productdetail_tab04.php?productcode=<?=$productcode?>&sort=<?=$sort?>#tapTop" rel="external"">상품문의(<?=$t_cnt4?>)</a></li>
			</ul>
		</section>
		<!-- //view탭 -->
		
		<!-- TAB4-상품문의 -->
		<section class="detail_04_view">
			<? include ("prqna_view.php"); ?>
		</section>
		<!-- //TAB4-상품문의 -->
