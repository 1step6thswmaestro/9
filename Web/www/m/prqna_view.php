...
<!--
		<div class="title_wrap">
			<span class="point1"><? if ($depth > 0) { echo "[답변]";	} else { echo "";	}?></span>
			<em><?=$date?></em>
			<em class="point1"><?=$str_name?></em>
			<!-- <strong class="secret"> --//>
			<strong><?=$title?></strong>
		</div>
-->
...
?>
	...
	<div class="pr_qna_button">
		<a style="cursor:pointer" rel="external" onClick="history.back()" class="button black bigrounded">목록보기</a>
		<a href="./passwd_confirm.php?board=qna&num=<?=$_REQUEST[num]?>&type=modify" rel="external" class="button white bigrounded">수정하기</a>
	</div>
</div>