...
<div id="content">
	...
	<div class="qna">
		<div style="margin-bottom:10px; overflow:hidden;">
			<div class="rowcount">전체 <?=$totalRecord?>건의 문의글이 있습니다.</div>
		...
		<div class="board_list">
			...
			<a class="page_block" href="<?=$write_addr?>">
				...
				<p class="writer"><?=date("Y-m-d",$qna_rows->writetime)?> <span class="hline">|</span> <?=$qna_rows->name?> <span class="hline">|</span> <?=$qna_rows->access?></p>
			</a>
			<?
						}
					}else{
