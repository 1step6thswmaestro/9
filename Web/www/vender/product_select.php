...
<?
	...
	if(ereg("^[A-Z]", $seachIdx)) {
		...
		if($seachIdx == "§°") $sql.= "WHERE (selectname >= '§°' AND selectname < '§§') OR (selectname >= '∞°' AND selectname < '≥™') ";
		if($seachIdx == "§§") $sql.= "WHERE (selectname >= '§§' AND selectname < '§ß') OR (selectname >= '≥™' AND selectname < '¥Ÿ') ";
		if($seachIdx == "§ß") $sql.= "WHERE (selectname >= '§ß' AND selectname < '§©') OR (selectname >= '¥Ÿ' AND selectname < '∂Û') ";
		if($seachIdx == "§©") $sql.= "WHERE (selectname >= '§©' AND selectname < '§±') OR (selectname >= '∂Û' AND selectname < '∏∂') ";
		if($seachIdx == "§±") $sql.= "WHERE (selectname >= '§±' AND selectname < '§≤') OR (selectname >= '∏∂' AND selectname < 'πŸ') ";
		if($seachIdx == "§≤") $sql.= "WHERE (selectname >= '§≤' AND selectname < '§µ') OR (selectname >= 'πŸ' AND selectname < 'ªÁ') ";
		if($seachIdx == "§µ") $sql.= "WHERE (selectname >= '§µ' AND selectname < '§∑') OR (selectname >= 'ªÁ' AND selectname < 'æ∆') ";
		if($seachIdx == "§∑") $sql.= "WHERE (selectname >= '§∑' AND selectname < '§∏') OR (selectname >= 'æ∆' AND selectname < '¿⁄') ";
		if($seachIdx == "§∏") $sql.= "WHERE (selectname >= '§∏' AND selectname < '§∫') OR (selectname >= '¿⁄' AND selectname < '¬˜') ";
		if($seachIdx == "§∫") $sql.= "WHERE (selectname >= '§∫' AND selectname < '§ª') OR (selectname >= '¬˜' AND selectname < 'ƒ´') ";
		if($seachIdx == "§ª") $sql.= "WHERE (selectname >= '§ª' AND selectname < '§º') OR (selectname >= 'ƒ´' AND selectname < '≈∏') ";
		if($seachIdx == "§º") $sql.= "WHERE (selectname >= '§º' AND selectname < '§Ω') OR (selectname >= '≈∏' AND selectname < '∆ƒ') ";
		if($seachIdx == "§Ω") $sql.= "WHERE (selectname >= '§Ω' AND selectname < '§æ') OR (selectname >= '∆ƒ' AND selectname < '«œ') ";
		if($seachIdx == "§æ") $sql.= "WHERE (selectname >= '§æ' AND selectname < '§ø') OR (selectname >= '«œ' AND selectname < '…°') ";
		$sql.= "ORDER BY selectname ";
	} else if($seachIdx == "±‚≈∏") {
